...
import { Calendar, MapPin, Truck, Play, CheckCircle, Plus } from 'lucide-react';
...
const ServicesList = () => {
  ...
  return (
    <div className="fade-in max-w-5xl mx-auto">
      ...
      {showForm && <ServiceForm onClose={() => setShowForm(false)} onSuccess={fetchServices} />}
            ...
            <div key={service._id} className="bg-white border border-gray-200 rounded-sm p-6 shadow-sm">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-xs font-bold text-blue-900 uppercase">{service.client?.fantasyName || service.client || '---'}</p>
                </div>
